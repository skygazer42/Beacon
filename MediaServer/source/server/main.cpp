...
int start_main(int argc,char *argv[]) {
    {
        ...
        if (secret == "035c73f7-bb6b-4889-a715-d9eb2d1925cc" || secret.empty()) { // gitleaks:allow -- upstream legacy default, never accepted
            ...
            WarnL << "The " << API::kSecret
                  << " was empty or used the upstream legacy default; generated a new value and saved config file: "
                  << g_ini_file;
        }
